    ...
    <footer className="bg-black w-full">
      <div className="max-w-screen-xl px-4 py-6 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center space-x-6">
          <a href="https://www.facebook.com/?locale=hu_HU" className="text-white hover:text-gray-300">
          ...
          <a href="https://x.com/?lang=hu" className="text-white hover:text-gray-300">
