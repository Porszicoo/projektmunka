...
export const Landing = () => {
  return (
    <section 
      className="w-full h-screen mt-12 bg-cover bg-no-repeat" 
      style={{ 
        backgroundImage: "url('/background.2.png')", 
        backgroundSize: "cover",  // Keeps the aspect ratio
        backgroundPosition: "center 25%", // Lift the image to show more of the logo on the shirt
        backgroundColor: "transparent",  // Ensures there's no unwanted white background color
      }}
    >
      <div className="grid max-w-screen-xl px-4 py-16 mx-auto gap-8 lg:gap-8 xl:gap-0 lg:grid-cols-12">
        ...
        <div className="mr-auto place-self-center lg:col-span-5 text-center lg:text-left">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-700 lg:mb-8 text-sm sm:text-base md:text-lg lg:text-xl">
