                                ...
                                <div key={item.id} className="grid grid-cols-3 items-start gap-4">
                                    <div className="col-span-2 flex items-start gap-4">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <button className="mt-6 text-red-500 text-xs font-semibold" onClick={() => removeItem(item.id)}>Törlés</button>
                                        </div>
                                    </div>
                                    <div className="ml-auto text-right">
                                        <p className="text-lg font-bold">{item.TermekAr} Ft</p>
                                        <div className="mt-2 flex items-center">
                                            <button className="px-2 py-1 border" onClick={() => changeQuantity(item.id, -1)}>-</button>
