            ...
            <div className="max-w-5xl max-md:max-w-xl mx-auto py-4">
                <div className="grid md:grid-cols-3 gap-8 mt-16 h-full w-full">
                        ...
                        <div className="grid grid-cols-3 items-start gap-4">
                            <div className="col-span-2 flex items-start gap-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-xs font-semibold text-gray-500 mt-0.5"></p>
                            ...
                            <div className="ml-auto">
                                <h4 className="text-lg max-sm:text-base font-bold text-gray-800"></h4>
                    ...
                    <div className="bg-gray-100 rounded-md p-4 h-max">
                        <h3 className="text-lg max-sm:text-base font-bold text-gray-800 border-b border-gray-300 pb-2">Rendelés összesítő</h3>

                        <form className="mt-6">
                            <div>
                                <h3 className="text-base text-gray-800  font-semibold mb-4">Rendelési adatok megadása</h3>
                        ...
                        <ul className="text-gray-800 mt-6 space-y-3">
                            <li className="flex flex-wrap gap-4 text-sm">Összeg:<span className="ml-auto font-bold"></span></li>
                            <li className="flex flex-wrap gap-4 text-sm">Rendelés: <span className="ml-auto font-bold"></span></li>
                            <li className="flex flex-wrap gap-4 text-sm">Áfa: <span className="ml-auto font-bold"></span></li>
                            <hr className="border-gray-300" />
                            <li className="flex flex-wrap gap-4 text-sm font-bold">Végösszeg: <span className="ml-auto"></span></li>
                        </ul>

                        <div className="mt-6 space-y-3">
                            <button type="button" className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-gray-800 hover:bg-gray-900 text-white rounded-md">Fizetés</button>
                            <button type="button" className=" text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent text-gray-800 border border-gray-300 rounded-md" onClick={() =>{
                                navigate("/");
