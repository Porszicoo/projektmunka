  ...
  return (
    <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
      <div className="text-center px-6">
        <h2 className="text-gray-800 text-3xl font-bold">Vedd fel velünk a kapcsolatot</h2>
        <p className="text-sm text-gray-500 mt-4">Van valami ötleted ami segítheti az oldalt?</p>
      </div>

      <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">

        <div className="bg-gray-950 rounded-lg p-6 h-full max-lg:order-1">
          <h2 className="text-xl text-white">Kapcsolati információ</h2>
          <p className="text-sm text-gray-300 mt-4">Segítség kell? Vagy csak elakadt a csomagod?</p>
        ...
        <div className="p-4 lg:col-span-2">
          <form>
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="relative flex items-center">
                <input type="text" placeholder="Családnév"
                  className="px-2 py-3 bg-white w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-500 outline-none" />
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2"
                  viewBox="0 0 24 24">
                  <circle cx="10" cy="7" r="6" data-original="#000000"></circle>
              ...
              <div className="relative flex items-center sm:col-span-2">
                <textarea placeholder="Írj üzenetet"
              ...
              <div className="col-span-full">
                ...
                <div className="flex max-lg:flex-col gap-6 mt-4">
                  <div className="flex items-center">
                    <input id="radio1" type="radio" name="problem-radio" className="hidden peer" checked />
                    ...
                    <p className="text-sm text-gray-500 ml-4">Általános probléma</p>
                  </div>

                  <div className="flex items-center">
                    <input id="radio2" type="radio" name="problem-radio" className="hidden peer" />
                    <label htmlFor="radio2"
                      className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                      <span className="border-[4px] border-[#011c2b] rounded-full w-full h-full"></span>
                    </label>
                    <p className="text-sm text-gray-500 ml-4">Technikai probléma</p>
                  </div>

                  <div className="flex items-center">
                    <input id="radio3" type="radio" name="problem-radio" className="hidden peer" />
                    <label htmlFor="radio3"
                      className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                      <span className="border-[4px] border-[#011c2b] rounded-full w-full h-full"></span>
                    </label>
                    <p className="text-sm text-gray-500 ml-4">Oldallal kapcsolatos visszajelzés</p>
                  </div>
                </div>
              </div>
            </div>
